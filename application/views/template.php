                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url()?>template/dist/img/logo.png" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Sekolah Awan Kinton</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            Sekolah Awan Kinton - Web Developer
